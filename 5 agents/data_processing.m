...
wind2_data = zeros(no_of_days,no_of_decision_hours);
...
for i = 1:size(wind2,1)
    index2 = floor(count_hour/6) + 1;
    if rem(count_hour,6) == 0 
        index2 = index2-1;
    end

    wind2_data(index1,index2) = wind2_data(index1,index2) + wind2(i);
...
wind2_mean = poissfit(wind2_data)/100;
